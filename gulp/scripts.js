...
function replaceSrcDir(path) {
  ...
  // path.dirname = path.dirname.replace(/^src\/components\/ng2-swipe-cards/ig, ''); // eslint-disable-line no-param-reassign
}
...
gulp.task('scripts:esm', (done) => {
  runSequence(
    ['scripts:esm-ngc'],
    // plugins requires change to import literals, ../../components/ng2-swipe-cards -> ng2-swipe-cards
